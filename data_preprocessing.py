...
train_data_file = open('C:/Users/aarus/Downloads/PRO-C122-Student-Boilerplate-Code-main/PRO-C122-Student-Boilerplate-Code-main/static/assets/chatbot_corpus/intents.json').read()
