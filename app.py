...
def save_entry():
    ...
    # CSV Entry
    entry = f'"{date}","{save_text}","{emotion}"/n'  

    with open("C:/Users/aarus/Downloads/PRO-C122-Student-Boilerplate-Code-main/PRO-C122-Student-Boilerplate-Code-main/static/assets/data_files/data_entry.csv", "a") as f:
        f.write(entry)
